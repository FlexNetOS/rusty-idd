...
| Role | Purpose | Repos |
|---|---|---|
| `Agent environment` | Supports agent runtime, skills, prompts, or execution environment | repo:agent, repo:agent-skills, repo:archon, repo:atc, repo:claude-code, repo:claude-plugin, repo:claude-plugins, repo:codex, repo:copilot-plugin, repo:ecc, repo:github-org, repo:hermes-agent, repo:icm, repo:kasetto, repo:n8n, repo:obscura, repo:oh-my-claudecode, repo:oh-my-pi, repo:prompt-hub, repo:rtk-tokenkill, repo:ruflo, repo:rusty-idd, repo:ruvector, repo:weave |
...
| `Fleet handoff` | Carries central and fleet handoff state for cross-repo agent continuity | repo:agent, repo:ecc, repo:envctl, repo:flexnetos-runner, repo:github-org, repo:handoff, repo:harness-hub, repo:lane, repo:lifeos, repo:meta-git-lib, repo:network-control, repo:prompt-hub, repo:rusty-idd, repo:ruvector, repo:teri, repo:weave |
...
| `claude-plugin` | `chore/meta-security-dep-bumps` | true | ai, plugin | role:agent-environment |  |
...
| `copilot-plugin` | `chore/meta-security-dep-bumps` | true | ai, plugin | role:agent-environment |  |
...
| `handoff` | `feat/hftask-0072-full-kb-adoption` | true | handoff, orchestration | role:coordination-domain-surface, role:fleet-handoff, role:rust-code-surface | rust, handoff, claude, github-actions, make |
...
| `meta_git_lib` | `chore/indicatif-0.18-rustsec-2025-0119` | false | canon | role:fleet-handoff, role:meta-control-plane, role:rust-code-surface | rust, handoff, github-actions |
...
| `network-control` | `develop` | false | network, tools | role:fleet-handoff, role:rust-code-surface | rust, handoff, claude, github-actions |
| `network_hub` | `master` | false | hub, network | role:capability-hub | github-actions |
| `obscura` | `main` | false | ai, browser, network | role:agent-environment, role:domain-upgrade-surface, role:rust-code-surface | rust, github-actions |
...
| `ruvector` | `docs/hooks-setup-integrated-tools` | true | ai, crates-only, forked, rust, wasm | role:agent-environment, role:fleet-handoff, role:rust-code-surface | rust, node, handoff, agents, claude, github-actions |
...
|---|---|---|---:|---|
| `rusty-idd` | 139 files, 8697 nodes, 35719 edges via `codegraph-rust` | 310 files, 711022 tokens via `repomix-rs` | 4 | codegraph-core, codegraph-parser, knowledge, tui, cli |
...
| `repo:meta-git-lib` | provides | `role:fleet-handoff` |
...
| `repo:ruvector` | provides | `role:fleet-handoff` |
