...
| `github_org` | `research/harness-upgrade-targets` | true | ci, org | role:agent-environment, role:fleet-handoff | handoff, agents, claude, github-actions, make |
...
|---|---|---|---:|---|
| `rusty-idd` | 135 files, 8296 nodes, 33472 edges via `codegraph-rust` | 163 files, 116033 tokens via `repomix-rs` | 4 | codegraph-core, codegraph-parser, tui, knowledge, runner |
