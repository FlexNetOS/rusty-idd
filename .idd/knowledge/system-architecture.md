...
| `Fleet handoff` | Carries central and fleet handoff state for cross-repo agent continuity | repo:handoff, repo:prompt-hub |
...
| `Rust code surface` | Contains Rust source that can be indexed by CodeGraph-backed Rusty IDD knowledge | repo:prompt-hub |
...
| `prompt_hub` | `` | false | ai, prompts | role:agent-environment, role:capability-hub, role:fleet-handoff, role:rust-code-surface, role:spec-producer | rust, openspec, idd-knowledge, handoff, agents, claude, github-actions, make, just |
...
|---|---|---|---:|---|
| `prompt_hub` | 139 files, 8697 nodes, 35719 edges via `codegraph-rust` | 310 files, 710946 tokens via `repomix-rs` | 4 | codegraph-core, codegraph-parser, knowledge, tui, cli |
...
| `repo:prompt-hub` | publishes | `artifact:.idd/knowledge/architecture.json` |
| `repo:prompt-hub` | maps_for_automation | `role:agent-environment` |
| `repo:prompt-hub` | provides | `role:agent-environment` |
| `repo:prompt-hub` | maps_for_automation | `role:capability-hub` |
| `repo:prompt-hub` | provides | `role:capability-hub` |
| `repo:prompt-hub` | maps_for_automation | `role:coordination-domain-surface` |
| `repo:prompt-hub` | scopes_as_feature_gated_surface | `role:coordination-domain-surface` |
| `repo:prompt-hub` | maps_for_automation | `role:documentation-knowledge` |
| `repo:prompt-hub` | maps_for_automation | `role:domain-upgrade-surface` |
| `repo:prompt-hub` | scopes_as_feature_gated_surface | `role:domain-upgrade-surface` |
| `repo:prompt-hub` | maps_for_automation | `role:fleet-handoff` |
| `repo:prompt-hub` | provides | `role:fleet-handoff` |
| `repo:prompt-hub` | uses_for_continuity | `role:fleet-handoff` |
| `repo:prompt-hub` | maps_for_automation | `role:knowledge-memory` |
| `repo:prompt-hub` | maps_for_automation | `role:meta-control-plane` |
| `repo:prompt-hub` | uses_for_workspace_inventory | `role:meta-control-plane` |
| `repo:prompt-hub` | maps_for_automation | `role:parser-runtime-surface` |
| `repo:prompt-hub` | uses_as_parser_runtime_evidence | `role:parser-runtime-surface` |
| `repo:prompt-hub` | maps_for_automation | `role:rust-code-surface` |
| `repo:prompt-hub` | provides | `role:rust-code-surface` |
| `repo:prompt-hub` | consumes_spec_intent_from | `role:spec-producer` |
| `repo:prompt-hub` | maps_for_automation | `role:spec-producer` |
| `repo:prompt-hub` | provides | `role:spec-producer` |
| `repo:prompt-hub` | maps_for_automation | `role:toolchain-provider` |
| `repo:prompt-hub` | uses_for_parent_managed_tools | `role:toolchain-provider` |
