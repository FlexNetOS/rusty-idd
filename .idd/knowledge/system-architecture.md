...
| Role | Purpose | Repos |
|---|---|---|
| `Agent environment` | Supports agent runtime, skills, prompts, or execution environment | repo:agent, repo:agent-skills, repo:archon, repo:atc, repo:claude-code, repo:claude-plugin, repo:claude-plugins, repo:codex, repo:copilot-plugin, repo:ecc, repo:hermes-agent, repo:icm, repo:kasetto, repo:oh-my-claudecode, repo:oh-my-pi, repo:prompt-hub, repo:rtk-tokenkill, repo:ruflo, repo:ruvector |
...
| `network-control` | `` | false |  |  |  |
| `network_hub` | `` | false | hub, network | role:capability-hub |  |
| `obscura` | `` | false | untriaged | role:domain-upgrade-surface |  |
...
| `ruvector` | `` | false | ai, forked, rust, wasm | role:agent-environment |  |
