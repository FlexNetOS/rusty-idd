...
- Graph nodes: 30894
- Graph edges: 112958
- Resolved call edges: 62259
- Functions with complexity: 7952
- Packed files: 136
- Packed tokens: 102008
- Suspicious files: 0
...
|---:|---|---|---|
| 33084 | `to_string` (26525) | `vendor/syntect/src/parsing/scope.rs` | 3307 graph links, 3304 call links, 1 unresolved calls, cyclomatic complexity 4 |
| 6406 | `collect` (17638) | `imports/prompt_hub/prompt-hub/src/garbage_collector.rs` | 43 lines, 637 graph links, 633 call links, 3 unresolved calls |
| 4978 | `main` (9912) | `hf/src/main.rs` | 467 lines, 433 graph links, 432 call links, 32 unresolved calls, cyclomatic complexity 23 |
| 4242 | `main` (14871) | `imports/handoff/hf/src/main.rs` | 358 lines, 372 graph links, 371 call links, 29 unresolved calls, cyclomatic complexity 21 |
| 4057 | `build_hf_args` (9037) | `hf/src/bin/hf-mcp.rs` | 352 lines, 357 graph links, 348 call links, 2 unresolved calls, cyclomatic complexity 48 |
...
| 2958 | `create_router` (24629) | `imports/prompt_hub/prompthub-server/src/server.rs` | 406 lines, 254 graph links, 250 call links, 12 unresolved calls |
| 2893 | `build_hf_args` (13599) | `imports/handoff/hf/src/bin/hf-mcp.rs` | 248 lines, 257 graph links, 248 call links, 2 unresolved calls, cyclomatic complexity 33 |
...
| 2610 | `new` (12572) | `imports/handoff/crates/tui/src/app.rs` | 35 lines, 259 graph links, 254 call links, 4 unresolved calls |
...
| 2267 | `into_response` (23853) | `imports/prompt_hub/prompthub-server/src/responses.rs` | 227 graph links, 225 call links, 1 unresolved calls |
...
| 2051 | `find` (23611) | `imports/prompt_hub/prompthub/src/fuzzy.rs` | 204 graph links, 199 call links, 3 unresolved calls, cyclomatic complexity 5 |
| 2045 | `implementation_loop` (11849) | `imports/handoff/crates/runner/src/runner.rs` | 342 lines, 155 graph links, 142 call links, 12 unresolved calls, cyclomatic complexity 52 |
