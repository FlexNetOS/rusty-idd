...
- Workspace fingerprint: `fnv1a64:d5a5c8516b210e40`
- Indexed source files: 134
- Graph nodes: 7841
- Graph edges: 30512
- Resolved call edges: 17133
- Functions with complexity: 1981
- Packed files: 108
- Packed tokens: 85355
- Suspicious files: 0
...
| 2601 | `new` (5417) | `crates/tui/src/app.rs` | 35 lines, 259 graph links, 254 call links, 1 unresolved calls |
| 2476 | `contains` (5132) | `crates/spec/src/model/spec.rs` | 249 graph links, 246 call links |
...
| 2025 | `implementation_loop` (4695) | `crates/runner/src/runner.rs` | 342 lines, 156 graph links, 143 call links, 2 unresolved calls, cyclomatic complexity 52 |
| 1707 | `handle_config_input` (5432) | `crates/tui/src/app.rs` | 133 lines, 151 graph links, 148 call links, 3 unresolved calls, cyclomatic complexity 19 |
...
| 1429 | `draw_config_screen` (6134) | `crates/tui/src/ui.rs` | 214 lines, 112 graph links, 108 call links, 13 unresolved calls, cyclomatic complexity 21 |
| 1408 | `new` (4654) | `crates/runner/src/runner.rs` | 145 graph links, 137 call links |
...
| 2952 | `crates/knowledge/src/lib.rs` |
