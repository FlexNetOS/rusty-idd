...
|---|---|---:|---:|
| `Agent runtime` | Agent harnesses, execution workers, and automation runtimes | 2 | 24 |
| `Coordination and communication` | Agent communication, orchestration, and cross-agent continuity | 3 | 6 |
...
- operating model derived from 65 repos and 12 roles in .idd/knowledge/system-architecture.json
