...
- Source graph: 135 files, 8395 nodes, 34012 edges
- Source languages: rust
- Context provider: `repomix-rs`
- Context package: 182 files, 127831 tokens
...
- repomix context package measured 182 files and 127831 tokens
