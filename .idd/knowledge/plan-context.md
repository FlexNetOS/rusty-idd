...
- Goal: verify merge-tools cleanup end-to-end and sync develop with main
- Workspace root: `/home/drdave/Desktop/meta/rusty-idd`
- Source graph: 138 files, 8532 nodes, 34813 edges via `codegraph-rust`
- Context package: 199 files, 138522 tokens via `repomix-rs`
...
| `core` | crate | 11 | 415 | 2389 | crates/core/src/cli.rs, crates/core/src/env_contract.rs, crates/core/src/fs_utils.rs, crates/core/src/lib.rs, crates/core/src/manifest.rs, crates/core/src/model.rs, crates/core/src/planner.rs, crates/core/src/scanner.rs, crates/core/src/templates.rs, crates/core/src/validation.rs, crates/core/tests/smoke.rs |
...
| `tool_hub` | `feat/stage-github-org-tool-pins` | true | role:capability-hub |  |
...
- system context selected 11 roles and 20 repos from 65 discovered repos
