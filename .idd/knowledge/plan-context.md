...
- Goal: # envctl-owned Rust toolchain and build cache
...
- Workspace root: `/home/drdave/Desktop/meta/rusty-idd/.worktrees/ci-envctl-rust-toolchain`
- Source graph: 139 files, 8764 nodes, 36181 edges via `codegraph-rust`
- Context package: 328 files, 726262 tokens via `repomix-rs`
