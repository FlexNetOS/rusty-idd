...
- Goal: # Prompt Hub Boundary Decision Goal
...
- Context package: 310 files, 710946 tokens via `repomix-rs`
...
|---|---|---|---|---|
| `prompt_hub` | `` | false | role:agent-environment, role:capability-hub, role:fleet-handoff, role:rust-code-surface, role:spec-producer | 139 files, 8697 nodes, 35719 edges; 710946 tokens; surfaces 4; top: codegraph-core, codegraph-parser, knowledge |
| `loop_cli` | `` | false | role:meta-control-plane |  |
| `meta_cli` | `` | false | role:meta-control-plane |  |
| `meta_core` | `` | false | role:meta-control-plane |  |
| `meta_git_cli` | `` | false | role:meta-control-plane |  |
| `meta_plugin_api` | `` | false | role:meta-control-plane |  |
| `meta_project_cli` | `` | false | role:meta-control-plane |  |
| `meta_rust_cli` | `` | false | role:meta-control-plane |  |
| `mcp_hub` | `` | false | role:capability-hub, role:coordination-domain-surface |  |
| `commands` | `` | false | role:capability-hub |  |
| `loop_lib` | `` | false | role:meta-control-plane |  |
| `meta_git_lib` | `` | false | role:meta-control-plane |  |
| `meta_plugin_protocol` | `` | false | role:meta-control-plane |  |
| `flow_hub` | `` | false | role:capability-hub |  |
...
| `template_hub` | `` | false | role:capability-hub |  |
...
- `Coordination and communication`: Agent communication, orchestration, and cross-agent continuity (3 capabilities, 7 repos)
...
| 20 | `Integrate Central and fleet handoff` | `integrate-fleet-handoff` | repo:handoff, repo:prompt-hub, repo:rusty-idd, repo:weave |  |
