...
- Goal: upgrade codex harness; update the codex ADR; target hooks, skills, and subagents; verify alignment with RTK, GRIT, and ICM hooks; scan then design
- Workspace root: `/home/drdave/Desktop/meta/rusty-idd`
- Source graph: 138 files, 8532 nodes, 34812 edges via `codegraph-rust`
- Context package: 199 files, 138488 tokens via `repomix-rs`
...
| `agent-skills` | `` | false | role:agent-environment |  |
...
| `hooks_hub` | `master` | false | role:capability-hub |  |
...
| `obscura` | `main` | false | role:domain-upgrade-surface, role:rust-code-surface |  |
