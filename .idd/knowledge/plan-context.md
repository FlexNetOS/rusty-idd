...
- Context package: 147 files, 108159 tokens via `repomix-rs`
...
| `rusty-idd` | `` | false | role:agent-environment, role:fleet-handoff, role:idd-control-plane, role:rust-code-surface | 134 files, 8178 nodes, 32790 edges; 108159 tokens; surfaces 4; top: codegraph-core, codegraph-parser, tui |
...
| `github_org` | `feat/policy-drift-token-rotation` | false | role:agent-environment, role:fleet-handoff |  |
