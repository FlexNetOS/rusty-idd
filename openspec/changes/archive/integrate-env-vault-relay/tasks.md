# integrate-env-vault-relay - Tasks
...
- [x] 1.3 Run native build/test/diagnostic commands before cutting local behavior.
- [x] 1.4 Adopt-first inputs to verify:
  - [x] `/run/media/drdave/COGNITUM`
  - [x] `Cognitum vault on Pi Zero`
