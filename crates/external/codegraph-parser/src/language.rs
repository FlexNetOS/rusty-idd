...
use tree_sitter::{Parser, LANGUAGE_VERSION, MIN_COMPATIBLE_LANGUAGE_VERSION};
...
impl LanguageRegistry {
    pub fn new() -> Self {
        ...
        // Temporarily disabled due to tree-sitter ABI mismatch with the
        // workspace-pinned runtime. The extractor remains vendored for a future
        // compatible pin or feature-gated multi-language graph slice.
        // configs.insert(
        //     Language::CSharp,
        //     LanguageConfig {
