...
"#;
        ...
        watcher
            ...
            .await?;
        let _ = timeout(Duration::from_secs(1), watcher.next_batch()).await?;
...
"#;
        ...
        for _ in 0..50 {
            ...
            if let Ok(Some(batch)) = timeout(Duration::from_secs(1), watcher.next_batch()).await {
...
"#;
        ...
        for _ in 0..50 {
            sleep(Duration::from_millis(100)).await;
            if let Ok(Some(_batch)) = timeout(Duration::from_secs(1), watcher.next_batch()).await {
