...
Interop rule: agents exchange durable intent, job, event, and proof objects; UI panels are replaceable shells. [H2][W2]

- prompt_hub emits selected prompt/intent bundles. [P1][P2]
- rusty-idd turns bundles into specs/tasks/validation/archive surfaces. [R1]
- planning-engineer emits cited roadmap artifacts and target DAGs. [P2]
- feature-forge consumes buildable chunks and returns tests/evidence. [H3]
- envctl installs/verifies components and publishes component state. [E1][E3]
- weave carries A2A messages/jobs/leases/permission asks and should use Damian/job lanes for background scans. [W1][W2]
- handoff records continuity, proof, rollback, next safe task, and resume packet. [H1][H2]
- LifeOS displays the owner-facing shell and control affordances. [L1][L2]
