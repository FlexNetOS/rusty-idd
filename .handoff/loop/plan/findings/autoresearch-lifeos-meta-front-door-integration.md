# autoresearch-lifeos-meta-front-door-integration.md

Freshness loop: external candidates such as Odysseus must be rechecked by URL/date before adoption. Current Odysseus evidence was retrieved 2026-06-26 from upstream README, requirements, compose, SECURITY, and LICENSE. Required checks: maintenance/release status, dependency pins, security posture, license changes, raw service exposure, and reproducible lock state. [O1][O2][O3][O4][O5]
