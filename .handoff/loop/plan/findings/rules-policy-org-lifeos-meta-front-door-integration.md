# rules-policy-org-lifeos-meta-front-door-integration.md

Org policy: strict-upgrade only, no destructive resets, no deleting legacy tools until replacements are installed/configured/parity-proven. LifeOS inherits upgrade-only and verification discipline; handoff supplies proof/rollback doctrine; envctl supplies no user-global install discipline; weave supplies token-light A2A/job routing. [L2][H1][H3][E1][W2]
