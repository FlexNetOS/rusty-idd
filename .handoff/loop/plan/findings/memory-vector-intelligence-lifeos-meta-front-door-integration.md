# memory-vector-intelligence-lifeos-meta-front-door-integration.md

LifeOS memory/vector intelligence should start from RVF format/runtime, selected vector traits, mcp-brain/mcp-gate, rvAgent, and handoff ledger projection. The RuVector runbook says all 314 crates were walked, but also warns to trust code dependencies/types/tests over prose and to avoid labeling apparently orphaned crates dead before searching all Cargo manifests. [V1][V2][H2][L2]
