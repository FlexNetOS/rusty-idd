# prompt-architecture-lifeos-meta-front-door-integration.md

Prompt architecture: prompt_hub stores/searches/versions prompts and includes the planning-engineer-loop prompt; rusty-idd is the spec/goal terminus of prompt_hub -> weave+rtk -> rusty-idd; LifeOS should provide owner-facing prompt/intent UI but not become the prompt database. [P1][P2][R1][L2]
