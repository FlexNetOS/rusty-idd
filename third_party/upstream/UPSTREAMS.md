...
| Handoff | https://github.com/FlexNetOS/handoff | `6365c12fc38f5d7247d81f9fdbd3a55817797904` | 550 | `third_party/upstream/handoff` |
...
as-is upstream reference for future agent-run/session integration planning.
Handoff is an as-is upstream reference for future task, ledger, delivery, fleet,
policy, and `.handoff` evidence adapter work. Upstream mirrors are not Cargo
workspace members. The full mirrors are preserved as the canonical upstream
reference before any cut is accepted. Every local cut must cite the native
upstream diagnostic that forced it and the rollback path back to this mirror.
